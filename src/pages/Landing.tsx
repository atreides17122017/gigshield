import { ShieldCheck, CloudRain, Zap, TrendingUp, ShieldAlert, ArrowRight } from 'lucide-react';
      ...
      <nav className="border-b border-white/20 bg-white/70 backdrop-blur-lg sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="bg-gradient-to-tr from-primary-600 to-accent-500 w-10 h-10 rounded-xl flex items-center justify-center shadow-lg shadow-primary-500/20">
              <ShieldCheck className="text-white w-6 h-6" />
            </div>
            <span className="text-2xl font-black tracking-tight text-slate-900">GigShield</span>
          </div>
      ...
      <section className="bg-white py-24 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto space-y-4 mb-16">
            <h2 className="text-4xl font-bold text-slate-900">How GigShield Works</h2>
      ...
      <footer className="bg-slate-900 text-slate-400 py-12 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-6 text-center space-y-6">
           <div className="flex justify-center items-center gap-2 mb-6 opacity-50">
             ...
             <span className="text-2xl font-black text-white tracking-tight">GigShield</span>
           </div>
           
           <p className="max-w-3xl mx-auto text-sm leading-relaxed">
             GigShield is a parametric income protection product designed strictly in alignment with IRDAI microinsurance guidelines. Coverage is explicitly for income loss only and does not serve as medical, health, or vehicle replacement insurance. 
