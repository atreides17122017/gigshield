...
const rules = [
  { keywords: ['claim', 'file', 'how do i'],
    response: "GigShield works automatically. When a disruption is detected in your zone, your claim is created instantly with no action needed. You get a notification when your payout is processed. Check Claim History for details." },
  { keywords: ['covered', 'coverage', 'what is covered'],
    response: "GigShield covers 5 disruptions: Heavy rainfall (50mm/3hrs), Extreme heat (43C/4hrs), Severe pollution (AQI>300), Curfew or Strike, and Platform outages over 2 hours. Coverage of specific triggers depends on your plan. Visit our Coverage page for full details." },
  { keywords: ['not covered', 'excluded', 'exclusion'],
    response: "GigShield does not cover vehicle repairs, health expenses, accidents, voluntary absence from work, war or military events, government-declared pandemics or epidemics, or fraudulent claims. See Terms and Conditions for the full exclusions list." },
  { keywords: ['pandemic', 'war', 'covid', 'epidemic'],
    response: "Government-declared pandemics, epidemics, and losses from war or civil conflict are explicitly excluded from GigShield coverage under IRDAI microinsurance exclusion standards." },
  ...
  { keywords: ['irdai', 'regulated', 'legal', 'regulation'],
    response: "GigShield is designed in alignment with IRDAI microinsurance guidelines and the Digital Personal Data Protection Act 2023. Your data is used only for premium calculation and claim verification, never sold." },
  { keywords: ['fraud', 'fake', 'spoofing'],
    response: "GigShield uses a 6-layer signal validation system including GPS, network IP, accelerometer data, weather confirmation, platform activity logs, and Trust Score to detect fraudulent claims. Coordinated fraud rings are detected using DBSCAN clustering analysis." },
  { keywords: ['hello', 'hi', 'hey'],
    response: "Hello! I am GigShield Assistant. I can help with coverage, claims, premiums, Trust Score, cancellation, and IRDAI compliance. What would you like to know?" }
];
...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<{sender: 'user'|'bot', text: string}[]>([
    { sender: 'bot', text: "Hello! I am GigShield Assistant. I can help with coverage, claims, premiums, Trust Score, cancellation, and IRDAI compliance. What would you like to know?" }
  ]);
